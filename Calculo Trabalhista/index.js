     function calcularSalario(){
        ...
        var respostaVT;
         ...
         res.innerHTML = (`Salário Bruto: R$ ${salario} || Desconto INSS: -R$ ${descontoINSS} || Desconto IRPF: -R$ ${descontoIRPF} || Desconto Vale Transporte: -R$ ${descontoVT} || Outras Deduções: -R$ ${outrasDeducoes} || Salário Líquido: R$ ${salarioLiquido}`);
